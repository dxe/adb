// DxE MODIFICATIONS
//
//  - Modified updateHotSettings so that it doesn't call
//    updateSettings on the table when the data has updated and the
//    number of columns haven't changed. We need to do this because
//    calling updateSettings on the table wipes undo/redo state, and
//    the data is already reactive because of Vue.
