...
<script>
// Country was changed to 'short_name' instead of 'long_name' by DxE (JH) on March 31, 2021.
// This is because that is our standard way for storing country data in our mailing list database.
