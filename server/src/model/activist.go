...
SELECT
  ...
  a.notes,
  a.vision_wall,
  mpp_requirements.MPP_Requirements as mpp_requirements,
  a.voting_agreement,
  a.street_address,
  a.city,
  a.state,
  ...
  a.consent_quiz,
  a.training_protest,
  a.dev_application_date,
  a.dev_application_type,
  a.dev_quiz,
  a.dev_interest,

  a.cm_first_email,
  a.cm_approval_email,
  a.prospect_organizer,
  a.prospect_chapter_member,
  a.referral_friends,
  a.referral_apply,
  a.referral_outlet,
  a.interest_date,
...
LEFT JOIN fb_pages fp ON fp.chapter_id = a.chapter_id
`
