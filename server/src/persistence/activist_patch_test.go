...
func TestPatchActivist_UpdatesAllPatchableFields(t *testing.T) {
	...
	patch := model.ActivistPatchData{Fields: []model.ActivistPatchField{
		...
		{Name: model.ColPreferredContactMethod, Value: "Signal"},
		{Name: model.ColAlternateContactMethod, Value: "Text / SMS"},
	...
	require.Equal(t, "Signal", a.PreferredContactMethod)
	require.Equal(t, "Text / SMS", a.AlternateContactMethod)
