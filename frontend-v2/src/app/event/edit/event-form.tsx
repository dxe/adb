...
// - why do all inputs flash on page load?
...
export const EventForm = () => {
  ...
  // TODO(jh): investigate why this is not working... maybe missing query client provider?
                      ...
                      return (
                        <div className="relative">
                          <Input
                            ...
                            // If name is empty of contains "name", seems safari tries to autocomplete it.
                            name="attendee"
                            // If placeholder contains "name", seems safari tries to autocomplete it.
                            placeholder=""
                            className={cn(
                          ...
                          <div className="right-0 top-0 bottom-0 h-full pointer-events-none absolute flex gap-2 items-center p-1.5 opacity-80">
                            ...
                            {/* TODO(jh): in a perfect world, maybe tapping these icons could open a modal to add the missing info (or a qr code to scan that prefills the name?) or maybe the check-in form can just automatically ask people if they are at at event, if an event is in progress, then add them to attendance automatically? */}
