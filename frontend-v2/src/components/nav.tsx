...
export const Navbar = ({
  ...
  const hasAccess = (roleRequired: string[] | undefined) => {
              ...
              hasAccess(dropdown.roleRequired) && (
                <div className="navbar-item has-dropdown" key={dropdown.label}>
                  ...
                  <div
                    ...
                    style={{
                      display:
                        activeDropdown === dropdown.label ? 'block' : 'none',
                    }}
                      ...
                      (item) =>
                        ...
                        (item.href.startsWith('/v2') ? (
                          <Link
                            ...
                            className={`navbar-item ${pageName === item.page ? 'is-active' : ''} ${item.separatorBelow ? 'mb-2' : ''}`}
                            key={item.href}
                          >
                            {item.label}
                          </Link>
