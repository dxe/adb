CREATE TABLE IF NOT EXISTS activists(
  ...
  dev_interest VARCHAR(1000) NOT NULL DEFAULT '',
  dev_auth VARCHAR(20),
  ...
  referral_friends varchar(500) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS form_application(
...
CREATE TABLE IF NOT EXISTS form_interest(
  id int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS form_discord(
  id int(11) NOT NULL AUTO_INCREMENT,
  discord_id BIGINT(18) DEFAULT NULL,
  first_name varchar(64) NOT NULL,
  last_name varchar(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS form_international_actions(
  id int(11) NOT NULL AUTO_INCREMENT,
